...
<td><input id="book_name" name="book_name" type="text" value="<jsp:getProperty name="book" property="bookName" />" class="name_input" required /></td>
</tr>
<tr> 
...
<tr> 
    ...
    <option value="Tokyo" <%= "Tokyo".equals(book.getLocation()) ? "selected" : "" %>>Tokyo</option> 
    <option value="Osaka" <%= "Osaka".equals(book.getLocation()) ? "selected" : "" %>>Osaka</option> 
    <option value="Nagoya" <%= "Nagoya".equals(book.getLocation()) ? "selected" : "" %>>Nagoya</option>
    <option value="Fukuoka" <%= "Fukuoka".equals(book.getLocation()) ? "selected" : "" %>>Fukuoka</option> 
    <option value="Sapporo" <%= "Sapporo".equals(book.getLocation()) ? "selected" : "" %>>Sapporo</option> 
    <option value="Naha" <%= "Naha".equals(book.getLocation()) ? "selected" : "" %>>Naha</option>
...
<p class="button"> 
    ...
    onclick="window.location.href='control?action_name=delete_confirm&prod_id=<jsp:getProperty name="book" property="productId"/>'; return false;" class="submit_button" />
    <% } %> 
